...
const EmojiPicker: React.FC<{
    ...
    return (
        ...
        <div style={{ height: '100%' }}>
            ...
            <Heading5 className="ion-padding-horizontal">Emoji</Heading5>


            <Picker onEmojiClick={onSelected} disableSkinTonePicker={true} disableSearchBar={true} preload={true} native={true} pickerStyle={{ width: '100%', height: '100%' }} />
        </div>
        // </div>
    )
                        ...
                        <ColumnContainer style={{ marginTop: "4em" }}>
                            ...
                            <RowContainer>
                                <IonCard
                                    ...
                                    button={true} color="medium" style={{ width: "max-content", fontSize: "1rem", padding: "0.5em", margin: "0" }}>
